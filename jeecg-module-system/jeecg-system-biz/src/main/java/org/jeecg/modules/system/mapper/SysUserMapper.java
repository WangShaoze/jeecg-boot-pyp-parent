...
public interface SysUserMapper extends BaseMapper<SysUser> {
	...
	@Select("select s.*, m.id as merchant_id from sys_user s left join t_b_merchants m on s.id = m.sys_uid where username = #{username}")
	SysUser selectUserByNameJoinMerchant(@Param("username") String userName);
}
