		...
		if (SqlCommandType.INSERT == sqlCommandType) {
			...
			for (Field field : fields) {
				...
				try {
					if ("createBy".equals(field.getName())) {
					...
					} else if ("createName".equals(field.getName())) {
						field.setAccessible(true);
						Object localCreateBy = field.get(parameter);
						field.setAccessible(false);
						if (localCreateBy == null || "".equals(localCreateBy)) {
					...
					} else if("sysOrgId".equals(field.getName())) {
						field.setAccessible(true);
						Object localSysOrgCode = field.get(parameter);
						field.setAccessible(false);
						if (localSysOrgCode == null || "".equals(localSysOrgCode)) {
							...
							if (sysUser != null) {
								field.setAccessible(true);
								field.set(parameter, sysUser.getOrgId());
								field.setAccessible(false);
							}
						}
					} else if("sysOrgName".equals(field.getName())) {
						field.setAccessible(true);
						Object localSysOrgCode = field.get(parameter);
						field.setAccessible(false);
						if (localSysOrgCode == null || "".equals(localSysOrgCode)) {
							...
							if (sysUser != null) {
								field.setAccessible(true);
								field.set(parameter, sysUser.getOrgName());
								field.setAccessible(false);
							}
						}
					} else if("companyCode".equals(field.getName())) {
						field.setAccessible(true);
						Object localSysOrgCode = field.get(parameter);
						field.setAccessible(false);
						if (localSysOrgCode == null || "".equals(localSysOrgCode)) {
							...
							if (sysUser != null) {
								field.setAccessible(true);
								field.set(parameter, sysUser.getCompanyCode());
								field.setAccessible(false);
							}
						}
						...
						if (localSysOrgCode == null || "".equals(localSysOrgCode)) {
							...
							if (sysUser != null) {
								field.setAccessible(true);
								field.set(parameter, sysUser.getCompanyId());
								field.setAccessible(false);
							}
						}
						...
						if (localSysOrgCode == null || "".equals(localSysOrgCode)) {
							...
							if (sysUser != null) {
								field.setAccessible(true);
								field.set(parameter, sysUser.getCompanyName());
								field.setAccessible(false);
							}
						}
					}
		...
		if (SqlCommandType.UPDATE == sqlCommandType) {
			...
			for (Field field : fields) {
				...
				try {
					...
					} else if ("updateName".equals(field.getName())) {
						//获取登录用户信息
						if (sysUser != null) {
							// 登录账号
							field.setAccessible(true);
